...
```bash
npx degit "jtolj/sapper-tailwind-template-rollup" my-app
```

### Using GitHub templates

Alternatively, you can use GitHub's template feature with the [sapper-tailwind-template-rollup](jtolj/sapper-tailwind-template-rollup) repository.
...
Tailwind is configured using tailwind.config.js. A minimal config has been provided. See the [Tailwind documentation](https://tailwindcss.com/docs/configuration/) for more details.
